...
const { createOrder,getOrderDetails,OrderViewUser,getSingleOrder,UpdateOrderStatus,deleteOrder } = require('../Controllers/OrderController');
...
OrderRouter.route('/admin/UpdateTheStatus/:id').put(auth,roleBasedAccess('admin'),UpdateOrderStatus).delete(auth,roleBasedAccess('admin'),deleteOrder);
