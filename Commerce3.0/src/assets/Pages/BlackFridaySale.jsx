...
function BlackFridaySale() {
  ...
  useEffect(()=>{
    ...
    const prod1=await axios.get(`${backendUrl}/api/v1/products/products?catogary=westernWomen`,{withCredentials:true
    })
    const prod2=await axios.get(`${backendUrl}/api/v1/products/products?catogary=westernMen`,{withCredentials:true});
